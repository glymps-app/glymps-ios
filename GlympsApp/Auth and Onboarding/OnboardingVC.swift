...
class OnboardingVC: UIPageViewController, UIPageViewControllerDataSource {
    ...
    var pageTitles = ["Welcome to Glymps!", "How it Works", "Messaging", "Heat Map", "Enable Notifications", "Enable Location", "Your Experience", "Good Luck!"] // titles for each page
...
""", """
Glymps collects limited user and device data to show relevant users to match with and advertisements, and reports product analytics to our Product team to enhance your user experience and make Glymps better. To get the best experience out of our app, please tap the button below and select "Allow".
""", "Ready when you are! Let's get you signed up!"] // labels for each page
    
    var pageImage = [#imageLiteral(resourceName: "glymps_logo_with_title"), #imageLiteral(resourceName: "swipe"), #imageLiteral(resourceName: "message-icon1"), #imageLiteral(resourceName: "heat-map"), #imageLiteral(resourceName: "notification"), #imageLiteral(resourceName: "location"),#imageLiteral(resourceName: "block-user"), #imageLiteral(resourceName: "rocket")] // background images for each page
